...
const registerValidation = Yup.object().shape({
  ...
  repeatPassword: Yup.string()
    .oneOf(
      [Yup.ref("password")],
      "Upprepat lösenord måste vara samma som lösenord"
    )
              ...
              {registerSuccess && (
                <View
                  style={{
                    ...
                    marginTop: 10,
                    borderWidth: 1,
                    borderColor: "rgba(43, 255, 0, 0.24)",
                    backgroundColor: "rgba(177, 231, 161, 0.308)",
                  }}
                >
                  <Text style={{ color: "#488e40" }}>
                    Registrering lyckades! Kolla din e-post för ett
                    bekräftelsemail
                  </Text>
                </View>
              )}
              ...
              {({ handleChange, handleBlur, values }) => (
                <View style={styles.border}>
                  <View>
                    <TextInput
                      style={styles.inputField}
                      // Funktionalitet som inte färdigställts
                      // onChangeText={(e) => {
